...
class WarehouseOptimizer:
    ...
    def ml_clustering_optimization(self, selected_store_ids, n_clusters=3):
        ...
        for i, center in enumerate(cluster_centers):
            ...
            recommended_warehouses.append(best_warehouse.to_dict())
...
def optimize_warehouse():
    data = request.json
    selected_store_ids = data.get('selectedStoreIds', [])
    ...
    try:
        if criterion == 'distance':
            ...
            result = optimizer.optimize_by_cost(selected_store_ids)
        elif criterion == 'capacity':
            result = optimizer.optimize_by_capacity(selected_store_ids)
