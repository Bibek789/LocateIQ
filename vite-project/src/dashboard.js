...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const map = L.map('map').setView([22.5726, 88.3639], 7); // Centered on West Bengal
    ...
    // Function to fetch and display map data
    ...
    if (contentSections['Dashboard']?.style.display !== 'none') {
